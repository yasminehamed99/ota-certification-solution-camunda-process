...
<xsl:transform xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="exists(cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'QR']/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) and string-length(cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'QR']/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) &gt; 700">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="error"
                                      id="BR-CL-KSA-14">
                     <xsl:attribute name="test">exists(cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'QR']/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) and string-length(cac:AdditionalDocumentReference[normalize-space(cbc:ID) = 'QR']/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) &gt; 700.</xsl:attribute>
                     <svrl:text>[KSA-14]-Field character limit for QR field has been exceeded. The maximum limit for this field is 700.</svrl:text>
            ...
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="exists(.) and string-length(.) &gt; 127">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      ...
                                      id="BT-CL-156">
                     <xsl:attribute name="test">exists(cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cbc:ID) and string-length(cac:InvoiceLine/cac:Item/cac:SellersItemIdentification/cbc:ID) &gt; 127</xsl:attribute>
                     <svrl:text>[BT-155]-Field character limit for Item Buyer's identifier field has been exceeded. The maximum limit for this field is 127.</svrl:text>
                     <svrl:message-code>BT-CL-155</svrl:message-code>
                     <svrl:message-category>KSA - business rules (BR-KSA)</svrl:message-category>
                  </svrl:failed-assert>
               </xsl:if>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e29">
               ...
               <xsl:if test="boolean(//*[matches(@name, '02\d{5}')])" >
                  <xsl:if test="not( format-number((cbc:TaxAmount),'#.00') = format-number( (round(((../cbc:LineExtensionAmount - ../../cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount) * (../cac:Item/cac:ClassifiedTaxCategory/cbc:Percent) div 100) * 100 ) div 100), '#.00')  )">
                     <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                         location="{schxslt:location(.)}"
                                         flag="WARNING"
                                         id="BR-KSA-50">
               ...
               <xsl:if test="boolean(//*[matches(@name, '02\d{5}')])" >
                  <xsl:if test="not( format-number((cbc:RoundingAmount),'#.00') = format-number( (round((  (cbc:TaxAmount) + (../cbc:LineExtensionAmount - ../../cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount) ) * 100 ) div 100), '#.00')  )">
                     <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                         location="{schxslt:location(.)}"
                                         flag="warning"
                                         id="BR-KSA-51">
   ...
   <xsl:template match="cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode"
      ...
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd7e29']">
            <schxslt:rule pattern="d7e29">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode" shadowed by preceding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
      ...
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd7e203']">
            <schxslt:rule pattern="d7e203">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID[@schemeID = 'HQ']" shadowed by preceding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
   ...
   <xsl:template match="/ubl:Invoice/cbc:InvoiceTypeCode[substring(@name, 1, 2) = '01']"
                 priority="29"
                 mode="d7e29">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e212">
               <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
				...
				<xsl:if test="boolean(//*[matches(@name, '01\d{5}')])" >
                  <xsl:if test="(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode) = 'SA' 
                  and not(
                  and exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName)
                  and exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:BuildingNumber) 
                  and exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone) and                 
                  exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName) and                
                  exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CitySubdivisionName) 
                  and exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode)))">
                     <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                         location="{schxslt:location(.)}"
                                         flag="error"
                                         id="BR-KSA-63">
               ...
               <xsl:if test="(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode) = 'SA' and exists(//cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CitySubdivisionName) and string-length(//cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CitySubdivisionName)&gt;127">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="error"
                                      id="KSA-CL-3">
               ...
               <xsl:if test="(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode) = 'SA' and exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PlotIdentification) and string-length(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PlotIdentification) &gt; 4">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="error"
                                      id="KSA-CL-19">
               ...
               <xsl:if test="boolean(//*[matches(@name, '02\d{3}6\d')])">
                  <xsl:if test="(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode) = 'SA' and not(exists(//cac:AccountingCustomerParty/cac:Party//cac:PartyLegalEntity/cbc:RegistrationName) and //cac:AccountingCustomerParty/cac:Party//cac:PartyLegalEntity/cbc:RegistrationName != '')">
                     <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                         location="{schxslt:location(.)}"
                                         flag="error"
                                         id="BR-KSA-71">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e225">
               ...
               <xsl:if test="not(exists(//cac:PaymentMeans) and exists(//cac:PaymentMeans/cbc:PaymentMeansCode) 
			   and contains(' 10 30 42 48 1 ', //cac:PaymentMeans/cbc:PaymentMeansCode))">
			...
			<xsl:if test="not(                 exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName) 
			   and                 exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName) 
			   and                 exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone) 
			   and                 exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CitySubdivisionName) 
			   and                 exists(//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode))">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d7e264">
               ...
               <xsl:if test="(/ubl:Invoice[cbc:InvoiceTypeCode = '381'] | /ubl:Invoice[cbc:InvoiceTypeCode = '383']) and not(exists(//cac:PaymentMeans/cbc:InstructionNote))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="warning"
                                      id="BR-KSA-17">
               ...
               <xsl:if test="(/ubl:Invoice[cbc:InvoiceTypeCode = '381'] | /ubl:Invoice[cbc:InvoiceTypeCode = '383']) and not(exists(//cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID) and (//cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID) != '')">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}"
                                      flag="error"
                                      id="BR-KSA-56">
